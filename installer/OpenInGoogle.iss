...
Name: "{group}\Beginner Credential Guide"; Filename: "{app}\OBTAIN_GOOGLE_CREDENTIALS_BEGINNER_GUIDE.md"
Name: "{group}\Setup Instructions"; Filename: "{app}\SETUP_FOR_USERS.md"
Name: "{group}\Security and Privacy"; Filename: "{app}\SECURITY_AND_PRIVACY.md"
...
[Run]
Filename: "{app}\SETUP_FOR_USERS.md"; Description: "Open setup instructions"; Flags: postinstall shellexec skipifsilent
